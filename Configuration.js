...
function getEndpoints(deviceAddress, endpoints) {
  ...
  endpoints.addEndpoint("1", "Temperatura del agua", endpointType.temperatureSensor);

  var e = endpoints.addEndpoint("2", "pH del agua", endpointType.genericSensor);
  e.variableTypeId = 1379; 

  var e = endpoints.addEndpoint("3", "Conductividad eléctrica del agua", endpointType.genericSensor);
  e.variableTypeId = 1380; 

  var e = endpoints.addEndpoint("4", "Oxígeno disuelto en el agua", endpointType.genericSensor);
  e.variableTypeId = 1381;

  var e = endpoints.addEndpoint("5", "Batería", endpointType.genericSensor);
